...
tags:
  ...
  - security
  - performance
summary: Review code changes across correctness, readability, architecture, security, performance, tests, and merge readiness.
examples:
  - review a pull request before merge
  - assess AI-generated code for bugs and regressions
  - verify a bug fix includes meaningful regression coverage
---
